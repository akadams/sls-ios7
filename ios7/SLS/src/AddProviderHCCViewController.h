//
//  AddProviderHCCViewController.h
//  SLS
//
...
@interface AddProviderHCCViewController : UIViewController <MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, UITextFieldDelegate>

#pragma mark - Inherited data (from MasterViewController)
@property (copy, nonatomic) PersonalDataController* our_data;
@property (copy, nonatomic) HCCPotentialPrincipal* potential_provider;
