...
// Note, we need to use delegation (as opposed to unwinding), because these classes will be called by both the AddProviderCTView and the AddConsumerCTView!
...
@interface AddProviderCTViewController : UIViewController <QREncodePKViewControllerDelegate, QRDecodePKViewControllerDelegate, QREncodeChallengeViewControllerDelegate, QRDecodeChallengeViewControllerDelegate, QREncodeDepositViewControllerDelegate, QRDecodeDepositViewControllerDelegate>
